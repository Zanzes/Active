...
using LZSoft.EditPlusC;

namespace EditPlusC_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new EditPlusCPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(LZSoft.EditPlusC.GuidList.guidEditPlusCCmdSet, (int)LZSoft.EditPlusC.PkgCmdIDList.OpenPairFile);
