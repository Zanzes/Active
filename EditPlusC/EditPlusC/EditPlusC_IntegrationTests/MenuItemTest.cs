...
namespace EditPlusC_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(LZSoft.EditPlusC.GuidList.guidEditPlusCCmdSet, (int)LZSoft.EditPlusC.PkgCmdIDList.OpenPairFile);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "EditPlusC", "LZSoft.EditPlusC.EditPlusCPackage");
